...
# <<< FIX #1: Paths are now relative to app.py *inside* Frontend_files >>>
TEAM_LOGOS = { 
...
def load_assets():
    ...
    try:
        ...
        # <<< FIX #2: Load all files from the same directory as the script >>>
        ...
        st.error(f"FATAL ERROR loading asset file: {e}. Ensure all data files (.pkl, .csv) are in the same 'Frontend_files' directory as app.py.")
